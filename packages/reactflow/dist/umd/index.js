(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactFlow = {}, global.React, global.ReactDOM));
  ...
  function selection_select(select) {
    if (typeof select !== "function") select = selector$i(select);
  ...
  function selection_insert(name, before) {
    var create = typeof name === "function" ? name : creator(name),
        select = before == null ? constantNull : typeof before === "function" ? before : selector$i(before);
    return this.select(function() {
  ...
  const getDirection$1 = ({ source, sourcePosition = exports.Position.Bottom, target, }) => {
  ...
  const selector$3$1 = (s) => `translate(${s.transform[0]}px,${s.transform[1]}px) scale(${s.transform[2]})`;
  ...
  function useNodesInitialized(options = defaultOptions) {
      const initialized = useStore(selector$h(options));
      return initialized;
  }
  ...
  var MiniMap$1 = React.memo(MiniMap);
  ...
  var Controls$1 = React.memo(Controls);
  ...
  const defaultColor = {
      [exports.BackgroundVariant.Dots]: '#91919a',
      [exports.BackgroundVariant.Lines]: '#eee',
      [exports.BackgroundVariant.Cross]: '#e2e2e2',
  };
  const defaultSize = {
  ...
  function Background({ id, variant = exports.BackgroundVariant.Dots, 
  ...
  var Background$1 = React.memo(Background);
  ...
  function NodeToolbar({ nodeId, children, className, style, isVisible, position = exports.Position.Top, offset = 10, align = 'center', ...rest }) {
      const contextNodeId = useNodeId();
      const nodesSelector = React.useCallback((state) => {
